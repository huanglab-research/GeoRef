...
**[Download official pre-trained models]** ([Google Drive](XXXX), [百度网盘](XXXX))
...
**[Download reproduced models and logs]** ([Google Drive](XXXX), [百度网盘](XXXX))

In addition, we upload the training process and curves in [wandb](XXXX).

**[Training curves in wandb](XXXX)**
...
| EDVR_REDS_SR_L | [REDS] (RGB) 31.09/0.8800 [[↓Results]](XXXXt)|
| EDVR_REDS_SRblur_L | [REDS] (RGB) 28.88/0.8361 [[↓Results]](XXXX)|
