...
* Decoupled Dynamic Filter Networks - XXXX

Thanks to Jiaqi Wang for the CARAFE repository and the associated paper:
* CARAFE: Content-Aware ReAssembly of FEatures - XXXX
...
class DDFUpPack(nn.Module):
    def __init__(self, in_channels=64, kernel_size=3, scale_factor=2, dilation=1, head=1, se_ratio=0.2,
